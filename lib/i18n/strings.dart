...
const Map<String, Map<String, String>> _dict = {
  ...
  // ── Share success story ──
  'successStory.entryButton':   {'hi': 'अपनी सफलता की कहानी साझा करें', 'en': 'Share your success story'},
  'successStory.title':         {'hi': 'सफलता की कहानी साझा करें', 'en': 'Share Your Success Story'},
  'successStory.subtitle':      {'hi': 'क्या आपको RishtaBook पर अपना जीवनसाथी मिला? हमारे साथ साझा करें - स्वीकृति के बाद यह होम पेज पर दिखेगी।', 'en': "Did you find your partner on RishtaBook? Share it with us — once approved, it'll show on the Home page."},
  'successStory.namesHint':     {'hi': 'जोड़े के नाम', 'en': "Couple's names"},
  'successStory.quoteHint':     {'hi': 'आपकी कहानी', 'en': 'Your story'},
  'successStory.weddingDateHint': {'hi': 'विवाह तिथि (वैकल्पिक)', 'en': 'Wedding date (optional)'},
  'successStory.photoUrlHint':  {'hi': 'फ़ोटो URL (वैकल्पिक)', 'en': 'Photo URL (optional)'},
  'successStory.submit':        {'hi': 'समीक्षा हेतु भेजें', 'en': 'Submit for review'},
  'successStory.submitted':     {'hi': 'भेजा गया - समीक्षा हेतु लंबित', 'en': 'Submitted — pending review'},
  'successStory.mySubmissions': {'hi': 'मेरी सबमिशन', 'en': 'My submissions'},
  'successStory.statusPending': {'hi': 'समीक्षा हेतु लंबित', 'en': 'Pending review'},
  'successStory.statusApproved': {'hi': 'स्वीकृत', 'en': 'Approved'},
  'successStory.statusRejected': {'hi': 'अस्वीकृत', 'en': 'Rejected'},
  ...
  'wallet.payViaUpi':      {'hi': 'UPI से भुगतान करें', 'en': 'Pay via UPI'},
  ...
  'wallet.submitTopup':    {'hi': 'सत्यापन के लिए भेजें', 'en': 'Submit for verification'},
  'wallet.topupSubmitted': {'hi': 'भेज दिया गया! सत्यापन के बाद क्रेडिट जुड़ जाएंगे।', 'en': "Submitted! Credits will be added after verification."},
